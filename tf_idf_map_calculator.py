...
if __name__ == '__main__':
    ...
    another_file = open('tf_idf_map_calculator.txt','w')
    ...
    for keys in query:
        ...
        another_file.write('Query Term:'+ str(index)+'\t'+'TF-IDF'+'\t'+str(precision)+'\t'+str(recall)+'\t'+str(f1_score)+'\t'+str(round(final_average_percision,3))+'\t'+'\n')
        my_categories.pop(0)
        index+=1
